...
// server.js
var import_fastify_cors = __toESM(require("fastify-cors"), 1);
...
var { PGHOST, PGDATABASE, PGUSER, PGPASSWORD, ENDPOINT_ID } = process.env;
var sql = (0, import_postgres.default)({
  host: PGHOST,
  database: PGDATABASE,
  username: PGUSER,
  password: PGPASSWORD,
...
var DatabasePostgres = class {
  ...
  // ###
  async create(video) {
    const videoId = (0, import_node_crypto2.randomUUID)();
...
var stripe = new import_stripe.default("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", {
  apiVersion: "2020-08-27"
});
var server = (0, import_fastify.default)();
server.register(import_fastify_cors.default, {
  origin: true
});
var database = new DatabasePostgres();
    ...
    line_items: [
      {
        price_data: {
          ...
          product_data: {
            name: "Presente"
            // Substitua pelo nome do produto
          },
          unit_amount: price
          // Substitua pelo preço em centavos
        },
        quantity: 1
        // Substitua pela quantidade necessária
      }
    ],
    mode: "payment",
    success_url: "http://localhost:3000"
    // Substitua pela URL de sucesso
